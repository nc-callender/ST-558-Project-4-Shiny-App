                        ...
                        sidebarPanel(
                            selectInput("type_of_graph", 
                                "Select a type of graph.",
                                 c("Bar Plot", "Histogram", "Scatter Plot", "Violin Plot", "Correlation Plot"),
                                 ),
                            conditionalPanel(condition = "input.type_of_graph == 'Histogram'",
                                selectInput("char_of_interest_graph",
                                "Select a characteristic for graphing.",
                                c("Radius", "Texture", "Perimeter", "Area", "Smoothness",
                                  "Compactness", "Concavity", "Concave Points", "Symmetry",
                                  "Fractal Dimension"))),
                            conditionalPanel(condition = "input.type_of_graph == 'Histogram'",
                                         selectInput("dim_of_interest_graph",
                                                     "Select a dimension for graphing.",
                                                     c("Mean", "Std Error", "Worst"))),
                            conditionalPanel(condition = "input.type_of_graph == 'Histogram'",
                                checkboxInput("grouping_graph",
                           ...
                           #End for histogram conditionals; Begin violin plot conditionals
                            conditionalPanel(condition = "input.type_of_graph == 'Violin Plot'",
                                             selectInput("char_of_interest_graph",
                                                         "Select a characteristic for graphing.",
                                                         c("Radius", "Texture", "Perimeter", "Area", "Smoothness",
                                                           "Compactness", "Concavity", "Concave Points", "Symmetry",
                            ...
                            conditionalPanel(condition = "input.type_of_graph == 'Violin Plot'",
                                             checkboxInput("grouping_graph",
                                                           "Do you want to color by malignant versus benign?")),
                        #End for violin plot conditionals; Begin scatter plot conditionals                        
                            conditionalPanel(condition = "input.type_of_graph == 'Scatter Plot'",
                                             selectInput("char_of_interest_graph_x",
                                                         "Select a characteristic for graphing on the x axis.",
                                                         c("Radius", "Texture", "Perimeter", "Area", "Smoothness",
                                                           "Compactness", "Concavity", "Concave Points", "Symmetry",
                                                           "Fractal Dimension"))),
                            conditionalPanel(condition = "input.type_of_graph == 'Scatter Plot'",
                                             selectInput("dim_of_interest_graph_x",
                                                         "Select a dimension for graphing on the x axis.",
                                                     c("Mean", "Std Error", "Worst"))),
                            conditionalPanel(condition = "input.type_of_graph == 'Scatter Plot'",
                                             selectInput("char_of_interest_graph_y",
                                                         "Select a characteristic for graphing on the y axis.",
                                                         c("Radius", "Texture", "Perimeter", "Area", "Smoothness",
                                                           "Compactness", "Concavity", "Concave Points", "Symmetry",
                                                           "Fractal Dimension"))),
                            conditionalPanel(condition = "input.type_of_graph == 'Scatter Plot'",
                                             selectInput("dim_of_interest_graph_y",
