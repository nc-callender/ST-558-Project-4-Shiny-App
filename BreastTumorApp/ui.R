...
h3("Generalized Linear Regression Model"),
       ...
       h3("Random Forest Model"),
        ...
        tags$span(style="color:purple;", strong(textOutput("rf_test_acc"))))
          ...
          tabPanel("Prediction",  fluidRow(column(12, box(width=12, h4("Selecting Values for Predictors"),
            fluidRow(
...
fluidRow(
 ...
 box(width = 12,background="light-blue",h4("Model Information"),
     "Current model(s) is/are:",textOutput("methods_for_prediction"), br(), textOutput("glm_variables1"),
     strong(textOutput("glm_variables2")),br(), textOutput("rf_variables1"),strong(textOutput("rf_variables2")))
 # column(width = 3, "Current model(s) is/are:"), column(width = 9, textOutput("methods_for_prediction")),
 # br(),
 # column(width = 3, textOutput("glm_variables1")), column(width = 9, strong(textOutput("glm_variables2"))),
 # br(),
 # column(width = 3, textOutput("rf_variables1")), column(width = 9, strong(textOutput("rf_variables2")))
...
box(width = 12, background="navy", h4("Prediction"), tags$span(style="color:green;", strong(textOutput("glm_predict_benign"))),
